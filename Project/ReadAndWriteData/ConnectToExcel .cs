...
//            using (var package = new ExcelPackage(new FileInfo(@"C:\Users\USER\Desktop\MyProject\Project\excel.xsl")))
//            {
...
//            // כתיבה לאקסל 
//            using (var excelPack = new ExcelPackage(new FileInfo(@"C:\Users\USER\Desktop\MyProject\Project\excel.xsl")))
//            {
